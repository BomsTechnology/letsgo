  ...
  return (
    <>
      <stack.Screen
        ...
        component={FavoriteDestinationScreen}
      ...
      <stack.Screen
        name="VehiculeDetail"
        component={VehiculeDetailScreen}
        options={{ headerShown: false }}
      />
      <stack.Screen
        name="SeatDetail"
      ...
      <stack.Screen
        name="OMPayMode"
        component={OMPayModeScreen}
        options={{ headerShown: false }}
      />
      <stack.Screen
        name="MOMOPayMode"
        component={MOMOPayModeScreen}
        options={{ headerShown: false }}
      />
      <stack.Screen
        name="CardPayMode"
        component={CardPayModeScreen}
        options={{ headerShown: false }}
      />
      <stack.Screen
        name="CashPayMode"
        component={CashPayModeScreen}
        options={{ headerShown: false }}
      />
      <stack.Screen
        name="TicketList"
