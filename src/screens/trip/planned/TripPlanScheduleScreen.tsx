    ...
    <View style={[styles.container]}>
      ...
      <View style={{ 
        ...
        alignItems: 'center'
          ...
          <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 20, marginLeft: 10 }}>Departure</Text>
      </View>
      ...
      <View style={{ 
        ...
        marginTop: 20
          ...
          <View style={{ 
              ...
              <Ionicons name="location-outline" size={25} color={Colors.whiteTone2} />
          </View>
          <Text style={{ fontFamily: 'Poppins_700Bold', fontSize: 20, marginLeft: 10 }}>Destination</Text>
      </View>
