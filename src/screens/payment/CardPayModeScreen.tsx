  ...
  return (
    ...
    <ScrollView style={styles.contentContainer} showsVerticalScrollIndicator={false}>
      ...
      <View key="fixed" style={[styles.fixedBox]}>
        <Text style={[styles.paragraph, {marginVertical: 5, color: Colors.secondaryColor}]}>Enter your Payment information</Text>
        
        <CreditCardField control={control}/>
...
export default CardPayModeScreen;
